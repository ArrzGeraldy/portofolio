...
import BarSkill from "@/components/skills/BarSkill";
        ...
        <article>
          ...
          <div className="mt-4 flex flex-col gap-4">
            <div className="flex gap-4 items-center">
              ...
              <BarSkill percentage={"95"} />
              <span>95%</span>
            </div>
            <div className="flex gap-4 items-center">
              <Css3Original size={32} />
              <BarSkill percentage={"85"} />
              <span>85%</span>
            </div>
            <div className="flex gap-4 items-center">
        ...
        <article>
          ...
          <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="flex gap-4 items-center ">
              ...
              <BarSkill percentage={"70"} />
              <span>70%</span>
            </div>
            <div className="flex gap-4 items-center">
              <LaravelOriginal size={32} />
              <BarSkill percentage={"80"} />
              <span>80%</span>
            </div>
            <div className="flex gap-4 items-center">
        ...
        <article>
          ...
          <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="flex gap-4 items-center">
              ...
              <BarSkill percentage={"60"} />
              <span>60%</span>
            </div>
            <div className="flex gap-4 items-center">
              <GoOriginal size={32} />
              <BarSkill percentage={"65"} />
              <span>65%</span>
            </div>
            <div className="flex gap-4 items-center">
